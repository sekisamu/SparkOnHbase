...
package cn.andlinks.cdhBased.cdhBased.hbasetwo.spark
...
import cn.andlinks.cdhBased.cdhBased.hbasetwo.spark.datasources.HBaseSparkConf
import org.apache.hadoop.hbase.{HConstants, TableName}


import scala.collection.mutable

 object HBaseConnectionCache extends Logging {
